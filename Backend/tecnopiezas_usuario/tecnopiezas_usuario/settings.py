"""
Django settings for tecnopiezas_usuario project.
...
SECRET_KEY = 'django-insecure-tq=3ln6%^+7418@6%wh8#k=*-my_6q@qah59z+%743ioj6s60y'
...
ROOT_URLCONF = 'tecnopiezas_usuario.urls'
...
WSGI_APPLICATION = 'tecnopiezas_usuario.wsgi.application'
